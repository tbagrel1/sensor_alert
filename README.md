...
![Capteurs](https://github.com/tbagrel1/sensor_alert/tree/master/.readme_resources/CapteurAllumeCapteurEteint.jpeg?raw=true)
...
![Renommage capteur](https://github.com/tbagrel1/sensor_alert/tree/master/.readme_resources/RenommageCapteur.png?raw=true)
...
![Indications generales](https://github.com/tbagrel1/sensor_alert/tree/master/.readme_resources/IndicateursGenerales.png?raw=true)
...
![Export](https://github.com/tbagrel1/sensor_alert/tree/master/.readme_resources/Export.png?raw=true)
...
![Preference vibration](https://github.com/tbagrel1/sensor_alert/tree/master/.readme_resources/PreferenceVibration.png?raw=true)

+ la plage horaire pendant laquelle une vibration sera produite en cas de changement d'état d'un
capteur.

![Preference notification](https://github.com/tbagrel1/sensor_alert/tree/master/.readme_resources/PreferenceNotification.png?raw=true)

+ la plage horaire pendant laquelle une notification sera émise en cas de changement d'état d'un
capteur.

![Preference mail](https://github.com/tbagrel1/sensor_alert/tree/master/.readme_resources/PreferenceMail.png?raw=true)
...
![Preference SMTP](https://github.com/tbagrel1/sensor_alert/tree/master/.readme_resources/PreferenceSMTP.png?raw=true)
...
![Préférence générale](https://github.com/tbagrel1/sensor_alert/tree/master/.readme_resources/PreferenceGenerale.png?raw=true)
